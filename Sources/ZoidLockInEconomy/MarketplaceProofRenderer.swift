...
public enum MarketplaceProofError: Error, Equatable, Sendable {
    case renderFailed
}
...
public enum MarketplaceProofRenderer: Sendable {
    ...
    public static let defaultProofURL = URL(
        fileURLWithPath: "/Users/ziadnasreldin/Work/GitHub/Zoid Lock In/screenshots/marketplace_proof.png"
    )

    @MainActor
    public static func renderPNG(
        snapshot: MarketplaceSnapshot = .proof,
        ...
        let view = MarketplacePopoverView(snapshot: snapshot)
        ...
        guard let bitmap = NSBitmapImageRep(
            ...
            throw MarketplaceProofError.renderFailed
        }
